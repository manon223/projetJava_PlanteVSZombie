...
public class plante {
    ...
    public plante(){
        ...
        this.attaque_par_seconde = 0.00;
        this.degat_attaque = 0;
        this.cout = 50;
        this.soleil_par_seconde = 25.00; //tounessol
        this.effet = "normal";
        this.chemin_image = "";
    }
    public plante(plante unePlante){
        this.nom = unePlante.getNom();
        this.point_de_vie = unePlante.getPoint_de_vie();
        this.attaque_par_seconde = unePlante.getAttaque_par_seconde();
        this.degat_attaque = unePlante.getDegat_attaque();
        this.cout = unePlante.getCout();
        this.soleil_par_seconde = unePlante.getSoleil_par_seconde();
        this.effet = unePlante.getEffet();
        this.chemin_image = unePlante.getChemin_image();
    }
